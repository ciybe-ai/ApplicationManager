...
public static class ConfigLoader
{
    ...
    public static async Task<List<BlacklistEntry>> LoadBlacklistAsync(string source, HttpClient http)
    {
        var json = await ReadSourceAsync(source, http);
    ...
    public static async Task<List<WishlistEntry>> LoadWishlistAsync(string source, HttpClient http)
    {
        var json = await ReadSourceAsync(source, http);
    ...
    /// </summary>
    private static async Task<string?> ReadSourceAsync(string source, HttpClient http)
    {
